...
public class CropImage
{
    ...
    public static final File FILE_LOCAL = new File(FILE_SDCARD,"imgCache");
	...
	private int outWidth=70;
	private int outHeight=70;
	
	public CropImage(Context context, CropImageView imageView,Handler handler,int width,int height)
	{
		mContext = context;
...
//        Rect dr = mCrop.mDrawRect;
       // int width = 500;//dr.width(); // modify by yc
       // int height = 500;//dr.height();
