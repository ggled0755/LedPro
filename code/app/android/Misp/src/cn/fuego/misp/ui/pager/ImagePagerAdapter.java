...
public class ImagePagerAdapter extends PagerAdapter implements OnPageChangeListener
{
	 ...
	 public ImagePagerAdapter(Context context,ViewGroup group,List<String> urlList,MispItemClickListener cListener)
	 {
     ...
     public void onPageSelected(final int arg0) {  
         ...
         imageList.get(arg0).setOnClickListener(new OnClickListener()
		{
			
			@Override
			public void onClick(View v)
			{
				cListener.onItemClick(arg0);
